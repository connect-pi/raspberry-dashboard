     ...
     <UCard>
       ...
       <div class="space-y-4">
         <div class="flex items-center justify-between">
           ...
           <span class="font-mono">{{ systemStats?.network?.ipAddress || 'N/A' }}</span>
         </div>
         <div class="flex items-center justify-between">
           <span class="text-gray-500 dark:text-gray-400">Network Interface</span>
           <span class="font-mono">{{ systemStats?.network?.interface || 'N/A' }}</span>
         </div>
         <div class="flex items-center justify-between">
           <span class="text-gray-500 dark:text-gray-400">Connected Clients</span>
           <span class="font-mono">{{ systemStats?.network?.connectedClients || 0 }}</span>
         </div>
       </div>
     </UCard>
   </UContainer>
